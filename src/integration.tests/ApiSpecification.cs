...
{
    public static Gen<string> GenerateOpenApi(string displayName, string description) =>
        from internet in Generator.Internet
        select $$"""
openapi: 3.0.1
info:
  title: {{displayName}}
  description: {{description}}
  termsOfService: {{internet.Url()}}
  contact:
    url: {{internet.Url()}}
...
""";
    ...
    // Inspiration from https://apidog.com/blog/examples-of-wsdl-files/
    public static Gen<string> GenerateWsdl(Uri uri, string displayName) =>
        from operation in Generator.AlphanumericWord
        from url in Generator.Uri
        select $$"""
...
<definitions xmlns="http://schemas.xmlsoap.org/wsdl/"
             ...
             targetNamespace="{{url}}">
    <types>
        <schema xmlns="http://www.w3.org/2001/XMLSchema" targetNamespace="{{url}}">
    ...
    <binding name="WeatherServiceSoapBinding" type="tns:WeatherServicePortType">
        ...
        <operation name="{{operation}}">
            <soap:operation soapAction="{{uri.AppendPathSegment(operation)}}"/>
            <input>
